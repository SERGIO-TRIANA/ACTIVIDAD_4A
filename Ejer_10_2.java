...
public class Ejer_10_2 {/*Implemente una función llamada cantDivisoresPos que reciba como parámetro un número
    entero y retorne la cantidad de divisores postitivos que tiene ese número. */
    public static void main(String[] args) {//este ejercicio es con while
        ...
        divisor = Funciones.canDivisorespos_2(numero);
